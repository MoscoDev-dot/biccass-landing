  ...
  return (
    <section className="py-20 text-center bg-gradient-to-r from-white to-[#54BE96]/10   md:px-20 px-4 ">
      ...
      <FadeIn
        ...
        duration={0.8}
        delay={0.1}
        className="flex justify-center mb-10 md:mb-15 w-fit mx-auto p-2 bg-white gap-3 items-center border border-0 shadow-lg rounded-[2vh] "
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center h-full">
        ...
        <FadeIn direction="up" delay={0.2} className="h-full">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col">
            ...
            <div className="bg-[#F9FAFB] p-6 rounded-xl mb-6 space-y-4 text-left flex-grow">
              {[
                "2 Users",
                "2 Files",
        ...
        <FadeIn direction="up" delay={0.3} className="relative z-10 h-full">
          <div className="bg-[#54BD95] p-8 rounded-2xl shadow-xl transform md:scale-105 relative text-white h-full flex flex-col">
            ...
            <div className="bg-white p-6 rounded-xl mb-6 space-y-4 text-left flex-grow">
              {[
                "4 Users",
                "All apps",
        ...
        <FadeIn direction="up" delay={0.4} className="h-full">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col">
            ...
            <div className="bg-brand-light p-6 rounded-xl mb-6 space-y-4 text-left flex-grow">
              {[
