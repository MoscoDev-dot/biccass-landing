    ...
    <section className="py-20 bg-[#F9F8FE]">
      <div className=" mx-auto md:px-20 px-4  grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
            {[
                { icon: "/activity 1.png", title: "Publishing", desc: "Plan, collaborate, and publishing your content that drives meaningful engagement and growth for your brand." },
                { icon: "/pie-chart 1.png", title: "Analytics", desc: "Analyze your performance and create gorgeous report." },
                { icon: "/command 1.png", title: "Engagement", desc: "Quickly navigate you and engage with your audience." },
            ].map((item, idx) => (
                <div key={idx} className="flex gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-[18px] md:text-[28px] text-[#191A15] ">{item.title}</h4>
                        <p className="text-[#A6A6A6] text-[12px] md:text-[18px] mt-1">{item.desc}</p>
                    </div>
                </div>
            ))}
        </div>
